...
app.get("/extraRunsConcededPertTeamIn2016DataConversionToJson", (req, res) => {
  ...
  app.get("/top10BowlersWithLeastConcededExtarRunsJsonDataConversionToJson", (req, res) => {
    const JsonData = top10BowlersWithLeastConcededExtarRunsJson;
    res.json(JsonData);
  });

  app.get("/countOfEachTeamWonTheTossAndMatchJsonDataConversionToJson", (req, res) => {
  ...
  app.get("/playerWhoWonTheHighestTimesPlayerOfTheMatchAwardJsonDataConversionToJson", (req, res) => {
    const JsonData = playerWhoWonTheHighestTimesPlayerOfTheMatchAwardJson;
    res.json(JsonData);
  });

  app.get("/bowlerWithBestEconomyInSuperOversJsonDataConversionToJson", (req, res) => {
